...
$measureId = 319;  // id ранее созданного мероприятия
$service_url = "https://v16077.vr.mirapolis.ru/mira/service/v2/measures/$measureId";
// $service_url = "https://systemurl.ru/mira/service/v2/measures/$measureId";
// задание массива параметров мероприятия
$parameters = array(
    'mename' => 'Измененное мероприятие 2',
    'mestartdate' => '2013-04-06 13:00:00.000',
