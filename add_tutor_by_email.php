<?php
  ...
  $tutor_email = "egulyaev@academy.ru";
  $measure_id = "200";
  $service_url = "https://v16077.vr.mirapolis.ru/mira/service/v2/measures/$measure_id/tutors/regbyemail/$tutor_email";
  $parameters = array(
  ...
  echo "Добавлен преподаватель $res";
